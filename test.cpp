...
int main()
{
    ...
    Shader shaderGeometryPass("shader.vs", "shader.fs");
    Shader shaderLightingPass("light.vs", "light.fs");
    Shader shaderSSAO("SSAO.vs", "SSAO.fs");
    Shader shaderSSAOBlur("blur.vs", "blur.fs");
    Shader shaderQuad("quad.vs", "quad.fs");
    
    Model nanosuit("G:/project/c++/LearnOpenGL/resources/objects/nanosuit/nanosuit.obj");
    ...
    glUniform1i(glGetUniformLocation(shaderQuad.ID, "gAlbedo"), 2);
    shaderSSAO.use();
    glUniform1i(glGetUniformLocation(shaderSSAO.ID, "gPosition"), 0);
    glUniform1i(glGetUniformLocation(shaderSSAO.ID, "gNormal"), 1);
    glUniform1i(glGetUniformLocation(shaderSSAO.ID, "noiseTexture"), 2);
